...
describe('<Home />', () => {
  ...
  it('should render search, posts and load more', async () => {
    render(<Home />);
    const noMorePosts = screen.getByText('Não foram encontrados posts para sua busca.');
  ...
  it('should search for posts', async () => {
    ...
    expect(screen.getByText('Não foram encontrados posts para sua busca.')).toBeInTheDocument();
  });
